...
public class MainPage extends JFrame {
	...
	public MainPage(File[] selectedFile) throws IOException {
		...
		setTitle("GEO-App");
		setIconImage(Toolkit.getDefaultToolkit().getImage(MainPage.class.getResource("/GUIPack/images/app-earth-icon.png")));
		...
		logoff.setIcon(new ImageIcon(MainPage.class.getResource("/GUIPack/images/Logout Rounded Up_32px.png")));
		...
		addIcon.setIcon(new ImageIcon(MainPage.class.getResource("/GUIPack/images/Plus Math_32px.png")));
		...
		filterIcon.setIcon(new ImageIcon(MainPage.class.getResource("/GUIPack/images/filter_32px.png")));
		...
		mapIcon.setIcon(new ImageIcon(MainPage.class.getResource("/GUIPack/images/Globe_32px.png")));
		...
		tableIcon.setIcon(new ImageIcon(MainPage.class.getResource("/GUIPack/images/Bulleted List_32px.png")));
		tableIcon.setForeground(new Color(248, 248, 255));
		
		JLabel csvButton = new JLabel("");
		csvButton.setIcon(new ImageIcon(MainPage.class.getResource("/GUIPack/images/CSV_32px.png")));
		
		JLabel kmlIcon = new JLabel("");
		kmlIcon.setIcon(new ImageIcon(MainPage.class.getResource("/GUIPack/images/KML_32px.png")));
		
		userIcon = new JLabel("");
		userIcon.setIcon(new ImageIcon(MainPage.class.getResource("/GUIPack/images/Location_50px.png")));
		
		modemIcon = new JLabel("");
		modemIcon.setIcon(new ImageIcon(MainPage.class.getResource("/GUIPack/images/Wi-Fi Router_50px.png")));
		
		infoIcon = new JLabel("");
		infoIcon.setIcon(new ImageIcon(MainPage.class.getResource("/GUIPack/images/Info_32px.png")));
